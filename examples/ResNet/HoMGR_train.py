...
from HoMGR_utils import (
    fbresnet_augmentor, get_HoMGR_dataflow, ImageNetModel,
    eval_on_HoMGR)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', help='HoMGR dataset dir')
